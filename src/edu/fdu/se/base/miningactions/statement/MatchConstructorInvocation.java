 ...
 */
public class MatchConstructorInvocation {

    public static void matchSuperConstructorInvocation(MiningActionData fp, Action a) {
        ...
        SuperConstructorInvocationChangeEntity code = new SuperConstructorInvocationChangeEntity(mBean);
...
//        code.stageIIBean.setOpt2(null);// 暂时不设置
    ...
    public static void matchSuperConstructorInvocationNewEntity(MiningActionData fp, Action a, Tree queryFather, int treeType, Tree traverseFather) {
        ChangePacket changePacket = new ChangePacket();
        List<Action> subActions = new ArrayList<>();
        if (!BasicTreeTraversal.traverseWhenActionIsMove(a, subActions, changePacket, false)) {
...
//        code.stageIIBean.setOpt2(null);// 暂时不设置
    ...
    public static void matchSuperConstructorInvocationCurrEntity(MiningActionData fp, Action a, ChangeEntity changeEntity, Tree traverseFather) {
...
//        changeEntity.linkBean.addAppendedActions(newActions);
    ...
    public static void matchConstructorInvocation(MiningActionData fp, Action a) {
        ChangePacket changePacket = new ChangePacket();
        List<Action> subActions = new ArrayList<>();
        if (!BasicTreeTraversal.traverseWhenActionIsMove(a, subActions, changePacket, false)) {
            DefaultUpDownTraversal.traverseTypeIStatements(a, subActions, changePacket);
...
//        code.stageIIBean.setOpt2(null);// 暂时不设置
    ...
    public static void matchConstructorInvocationNewEntity(MiningActionData fp, Action a, Tree queryFather, int treeType, Tree traverseFather) {
        ChangePacket changePacket = new ChangePacket();
        List<Action> subActions = new ArrayList<>();
        if (!BasicTreeTraversal.traverseWhenActionIsMove(a, subActions, changePacket, false)) {
            DefaultDownUpTraversal.traverseFatherNodeGetSameNodeActions(traverseFather, subActions, changePacket);
...
//        code.stageIIBean.setOpt2(null);// 暂时不设置
    ...
    public static void matchConstructorInvocationCurrEntity(MiningActionData fp, Action a, ChangeEntity changeEntity, Tree traverseFather) {
        ChangePacket changePacket = changeEntity.clusteredActionBean.changePacket;
        List<Action> actions = changeEntity.clusteredActionBean.actions;
        List<Action> newActions = new ArrayList<>();
        if (!BasicTreeTraversal.traverseWhenActionIsMove(a, newActions, changePacket, false)) {
